...
class Actions:
    ...
    def Download(main_window, serv_location):
        """Вложенная функция, которая скачивает файл с FTP-сервера."""
        def download_action():
    ...
    def Record(main_window, local_location, server_location):
        """Вложенная функция, которая записывает файл на FTP-сервер."""
        def recording():
    ...
    def Delete_Serv(main_window, serv_location, parent):
        """Вложенная функция, которая удаляет файл с FTP-сервера."""
    ...
    def Delete_Loc(main_window, local_location, file_tree, file_model):
        """Вложенная функция, которая удаляет файл с локального компьютера."""
